...
$pdf->Cell(0,5,utf8_decode("Estado: Goiás"),0,1,'L');
$pdf->Image('goias.png',20,50,-100);
$pdf->Ln(20);
$pdf->Ln(20);
$pdf->Ln(20);
$pdf->Ln(20);
...
$pdf->Ln(25);
$pdf->Cell(0,-125,utf8_decode("Sintomas:febre, tosse, dor de garganta, dores musculares, dor de cabeça, calafrios,"),0,1,'L');
$pdf->Ln(12);
$pdf->Cell(0,130,utf8_decode("corrimento nasal e cansaço. Também são comuns enjoos, vômitos e diarreia."),0,1,'L');
$pdf->Output("go-gripesuina.pdf","I");
?>